                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="text-align:center"><?php echo $list_data->kode_konsumen ?> </td>
                                                                <td style="text-align:center"><?php echo $list_data->nama_konsumen ?> </td>
                                                                <td style="text-align:center"><?php echo $list_data->nmr_kontak_konsumen ?> </td>
                                                                <td style="text-align:center"><?php echo $list_data->alamat_konsumen ?> </td>
