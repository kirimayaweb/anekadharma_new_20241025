                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="row">
                                    <div class="col-12" text-align="center"> STATUS SPOP <strong><?php echo $spop; ?> </strong></div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <label for="supplier_nama">Atur Status Transaksi </label>
                                    <!-- <textarea class="form-control" rows="3" name="supplier_nama" id="supplier_nama" placeholder="Supplier Nama"><?php //echo $supplier_nama; 
                                                                                                                                                        ?></textarea> -->


                                    <select name="uuid_status_transaksi" id="uuid_status_transaksi" class="form-control select2" style="width: 100%; height: 40px;" required>
                                        <option value="">Pilih Status</option>
                                        <?php

                                        $sql = "select * from sys_status_transaksi order by status ASC";


                                        foreach ($this->db->query($sql)->result() as $m) {
                                            // foreach ($data_produk as $m) {
                                            echo "<option value='$m->uuid_status_transaksi' ";
                                            echo ">  " . strtoupper($m->status)  . "</option>";
                                        }
                                        ?>
                                    </select>
