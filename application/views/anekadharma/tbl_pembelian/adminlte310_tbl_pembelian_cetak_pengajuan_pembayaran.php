						...
						<table id="customers">
							...
							<tr style="border: 1px solid black; border-top: none; border-bottom: none; border-collapse: collapse;">
								...
								<th style="font-size:0.550em; text-align:left; width: 348px;" colspan="348">
									<input type="text" name="jumlah_nominal" id="jumlah_nominal" placeholder="Nomor Permohonan" value="<?php echo nominal($nominal_pengajuan); ?>">
								</th>

								<th style="font-size:0.550em; text-align:left; width: 100px;" colspan="100">TANGGAL</th>

								<th style="font-size:0.550em; text-align:left; width: 400px;" colspan="400">
									<input type="text" class="form-control datetimepicker-input" data-target="#tgl_permohonan" id="tgl_permohonan" name="tgl_permohonan" required />
							...
							<tr style="border: 1px solid black; border-top: none; border-bottom: none; border-collapse: collapse;">
								...
								<th style="font-size:0.550em; text-align:left; width: 100px;" colspan="102">
									BANK &ensp; ( <input type="checkbox" class="radio" value="1" name="bank_checkbox" id="bank_checkbox" />)
			...
			<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-4">
						...
						<!-- <a href="<?php //echo site_url('tbl_pembelian/cetak_pengajuan_bayar_per_spop/' . $uuid_spop) ?>" class="btn btn-success" target="_blank">Cetak Pengajuan Pembayaran (PDF)</a> -->
