                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-2" align="left">
                                        <div class="col-12" text-align="center"> <strong>PEMBAYARAN BEA OPERASIONAL</strong></div>
                                    </div>
                                    <div class="col-2" align="left">
                                        <?php echo anchor(site_url('Tbl_bea_operasional/input_saldo'), 'Input Saldo', 'class="btn btn-danger"');
                                        ?>

                                    </div>
                                    <div class="col-2" align="left">

                                        <?php echo anchor(site_url('Tbl_bea_operasional/pembayaran'), 'Pembayaran', 'class="btn btn-success"');
                                        ?>
                                    </div>
                                    <div class="col-6" align="right">

                                        <?php echo anchor(site_url('Tbl_bea_operasional/excel'), 'Cetak ke Excel', 'class="btn btn-success"'); ?>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                ...
                                                <table id="example" class="display nowrap" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($Tbl_bea_operasional_data as $list_data) {
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left">
                                                                    ...
                                                                    echo ' ';
                                                                    echo anchor(site_url('Tbl_bea_operasional/delete/' . $list_data->id), '<i class="fa fa-trash-o">Hapus</i>', 'title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                                                                    ?>
                                                                </td>
