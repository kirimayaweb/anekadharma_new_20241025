                    ...
                    <div class="card-header">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-2" text-align="left">
                                <strong>DATA PEMBELIAN JASA</strong>
                            </div>
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                ?>
                                <form id="form-cari-pembelian-jasa" action="<?php echo $action_cari_between_date; ?>" method="post" class="mb-0" style="display: inline-block; width: 100%; max-width: 360px;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <div class="input-group date mr-2" id="filter_bulan" data-target-input="nearest" style="width: 170px;">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#filter_bulan" id="filter_bulan_input" name="filter_bulan" value="<?php echo htmlspecialchars(date('m/Y', $__ts_filter_bulan), ENT_QUOTES, 'UTF-8'); ?>" placeholder="MM/YYYY" required autocomplete="off" />
                                        ...
                                        <button type="submit" class="btn btn-danger btn-flat">
                                            <i class="fa fa-sign-in" aria-hidden="true"></i> Cari
                                        </button>
                                    </div>
                                </form>
                            </div>
...
<script>
    ...
    function cetakExcelPembelianJasa() {
        ...
        var tglAwalEl = document.querySelector('#form-cari-pembelian-jasa input[name="tgl_awal"]');
        var tglAkhirEl = document.querySelector('#form-cari-pembelian-jasa input[name="tgl_akhir"]');
...
(function() {
    ...
    window.submitCariPembelianJasaOtomatis = submitCariPembelianJasaOtomatis;
    function initFilterBulanPicker() {
        ...
        $picker.on('change.datetimepicker.filterBulan', function(e) {
            ...
            submitCariPembelianJasaOtomatis();
        });
        var inp = form.querySelector('input[name="filter_bulan"]');
        if (inp) inp.addEventListener('change', submitCariPembelianJasaOtomatis);
    }
