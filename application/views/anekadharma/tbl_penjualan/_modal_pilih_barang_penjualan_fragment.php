...
foreach ($Data_stock as $list_data) {
	...
	$sisa_stock_data = (int) $list_data->jumlah_sediaan - ((int) $list_data->penjualan + (int) $list_data->pecah_satuan_persediaan + (int) $list_data->bahan_produksi);
	...
	if ($fragment_part === 'tbody') {
		...
		<tr>
			...
			<td align="right"><?php echo nominal($sisa_stock_data); ?></td>
			<td align="left">
				<button type="button" class="btn <?php echo $btn_class; ?> btn-xs" data-toggle="modal" data-target="#modal-xl_1_<?php echo (int) $list_data->id; ?>"<?php echo $btn_disabled; ?>>PILIH BARANG</button>
			</td>
		</tr>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-4">
									<label style="color:red">Jumlah Maks= <?php echo (int) $sisa_stock_data; ?></label>
									<input type="number" class="form-control" name="jumlah" min="1" max="<?php echo (int) $sisa_stock_data; ?>">
								</div>
							</div>
						</div>
