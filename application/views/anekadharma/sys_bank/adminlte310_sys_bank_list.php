            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="col-12" text-align="center"> <strong>DATA BANK</strong></div>
                            </div>
                            <div class="col-6">
                                <?php echo anchor(site_url('Sys_bank/create'), 'Input Data Bank', 'class="btn btn-danger"');
                                ?>
                            </div>
                            <div class="col-2">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        $url_excel = isset($url_sys_bank_excel)
                            ? $url_sys_bank_excel
                            : site_url('Sys_bank/excel');
                        ?>
                        <div class="row mb-3">
                            <div class="col-12 text-right">
                                <a href="<?php echo htmlspecialchars($url_excel, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-success" id="btn-sys-bank-excel">
