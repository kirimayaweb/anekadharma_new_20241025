						...
						<div class="col-8">
							...
							<table id="customers">
								...
								<tr>
									...
									<th style="font-size:0.550em; text-align:right; border-top:none;border-bottom:none; width: 150px;border: 1px solid black;border-top:none;border-bottom:none;  border-right:none;border-left:none;  border-collapse: collapse;" colspan="150">
										<?php if (isset($data_detail->aktiva_tetap)) { echo nominal($data_detail->aktiva_tetap);} ?>
									</th>
								...
								<tr>
									...
									<th style="font-size:0.550em; text-align:right; border-top:none;border-bottom:none; width: 150px;border: 1px solid black;border-top:none;border-bottom:none;  border-right:none;border-left:none;  border-collapse: collapse;" colspan="150">
										<?php if (isset($data_detail->ljpj_kerjasama_pdu_cabean_panggungharjo)) { echo nominal(
			...
			<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-4">
						...
						<a href="<?php echo site_url('tbl_neraca_data/cetak_pengajuan_bayar_per_spop/' . $uuid_pengajuan_bayar_terproses)
