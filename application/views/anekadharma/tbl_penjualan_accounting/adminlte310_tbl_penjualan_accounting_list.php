                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-6" text-align="center"> <strong>DATA PENJUALAN ACCOUNTING</strong></div>
                                    <div class="col-6" text-align="center"> <strong><?php echo anchor(site_url('tbl_penjualan_accounting/create'), 'Input PENJUALAN BARU', 'class="btn btn-danger"'); ?></strong></div>
                            ...
                            <div class="col-2">
                            <?php //echo anchor(site_url('tbl_penjualan_accounting/RekapPenjualanPerBarang'), 'Rekap Penjualan', 'class="btn btn-success"'); ?>
                            </div>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                echo anchor(site_url('tbl_penjualan_accounting/cetak_penjualan_per_uuid_penjualan/' . $list_data->uuid_penjualan . '/' . $date_tgl_jual . '/' . $list_data->nmrkirim), '<i class="fa fa-pencil-square-o" aria-hidden="true">Cetak </i>', 'class="btn btn-success btn-xs"  target="_blank"');

                                                // echo anchor(site_url('tbl_penjualan_accounting/kasir_penjualan/' . $list_data->uuid_penjualan . '/' . $date_tgl_jual . '/' . $list_data->nmrkirim), '<i class="fa fa-pencil-square-o" aria-hidden="true">Tambah </i>', 'class="btn btn-danger btn-xs"  target="_blank"');
                                                
                                                echo anchor(site_url('tbl_penjualan_accounting/kasir_penjualan/' . $list_data->uuid_penjualan), '<i class="fa fa-pencil-square-o" aria-hidden="true">Ubah Data</i>', 'class="btn btn-warning btn-xs"  ');
                                            ...
                                            <td align="left">
                                                ...
                                                // echo anchor(site_url('tbl_penjualan_accounting/update_penjualan/' . $list_data->uuid_penjualan_proses), '<i class="fa fa-pencil-square-o" aria-hidden="true">Ubah</i>', 'class="btn btn-warning btn-xs"  ');
                                                // echo "";
                                                // HAPUS
                                                // echo anchor(site_url('tbl_penjualan_accounting/delete/' . $list_data->id), 'Hapus', 'onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus Data Penjualan ini ?\')" ');
                                                ?>
                                            </td>
