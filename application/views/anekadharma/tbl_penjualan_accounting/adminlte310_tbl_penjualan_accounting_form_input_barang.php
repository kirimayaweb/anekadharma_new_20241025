                ...
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                        echo anchor(site_url('tbl_penjualan_accounting/delete/' . $list_data->id . '/' . $list_data->uuid_penjualan), 'Hapus DATA', 'onclick="javascript: return confirm(\'Anda Yakin akan Menghapus Penjualan Barang ini ?\')"');

                                                        // echo anchor(site_url('tbl_penjualan_accounting/delete/' . $list_data->id . '/' . $list_data->uuid_penjualan), 'onclick="javascript: return confirm(\'Anda Yakin akan Menghapus Penjualan Barang ini ?\')"', '<i class="btn btn-outline-info btn-block btn-flat" aria-hidden="true">Hapus</i>', 'class="btn btn-block btn-flat"  ');
                        ...
                        <!-- <button type="submit" class="btn btn-primary"><?php //echo $button 
                                                                            ?></button> -->
                        <a href="<?php echo site_url('tbl_penjualan_accounting') ?>" class="btn btn-default">Kembali ke Halaman Data Penjualan</a>
                        <?php
                        if (isset($uuid_penjualan)) {
                        ?>

                            <a href="<?php echo site_url('tbl_penjualan_accounting/cetak_penjualan_per_uuid_penjualan/' . $uuid_penjualan) ?>" class="btn btn-primary" target="_blank">Cetak Penjualan</a>

                        <?php
                        }
                        ?>

                        <!-- <a href="<?php //echo site_url('tbl_penjualan_accounting') 
                    ...
                    <table id="example" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            foreach ($Data_stock as $list_data) {
                                ...
                                // $sql = "SELECT sum(`jumlah`) as jumlah_jual FROM `tbl_penjualan_accounting` WHERE `uuid_barang`='$list_data->uuid_barang'";
        ...
        <div class="modal fade" id="modal-xl-input-barang_<?php echo $list_data->id ?>">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    $row_data_barang_jual = $this->Tbl_penjualan_accounting_model->get_by_id($list_data->id);
