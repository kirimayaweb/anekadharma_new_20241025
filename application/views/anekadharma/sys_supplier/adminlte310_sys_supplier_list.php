                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="col-12" text-align="center"> <strong>DATA SUPPLIER</strong></div>
                                    </div>
                                    <div class="col-6">
                                        <?php echo anchor(site_url('Sys_supplier/create'), 'Tambah Supplier Baru', 'class="btn btn-danger"'); 
                                        ?>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                ...
                                                <table id="example" class="display nowrap" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($data_supplier as $list_data) {
                                                        ?>
                                                            <tr>
