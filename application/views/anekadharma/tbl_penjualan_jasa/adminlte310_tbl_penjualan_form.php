                        ...
                        <form action="create_action_inisiasi/new" method="post" id="form-penjualan-create-inisiasi">
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-muted d-block mt-1" id="info-tgl-jual-penjualan">
                                    Tanggal jual default mengikuti <strong>tanggal akhir</strong> filter halaman DATA PENJUALAN JASA. Ubah sesuai kebutuhan sebelum klik Input jasa penjualan.
                                </small>
                            </div>
    ...
    function updateBtnInputBarangPenjualan() {
        ...
        if (boleh) {
            ...
            $('#info-tgl-jual-penjualan').removeClass('text-danger').addClass('text-muted')
                .html('Tanggal jual default mengikuti <strong>tanggal akhir</strong> filter halaman DATA PENJUALAN JASA. Ubah sesuai kebutuhan sebelum klik Input jasa penjualan.');
        } else {
            $btn.attr('title', 'Isi Tgl Jual terlebih dahulu');
            $('#info-tgl-jual-penjualan').removeClass('text-muted').addClass('text-danger')
                .text('Tgl Jual wajib diisi sebelum klik Input jasa penjualan.');
        }
    }
    ...
    $('#form-penjualan-create-inisiasi').on('submit', function(e) {
        ...
        if (!tglJual) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    ...
                    text: 'Pilih atau isi tanggal jual terlebih dahulu sebelum Input jasa penjualan.'
                });
            } else {
        ...
        if (bulanList && bulanInput && bulanInput !== bulanList) {
            ...
            var pesan = 'Bekerja di halaman penjualan bulan <strong>' + labelList + '</strong>, '
                ...
                + 'Lanjutkan Input jasa penjualan sesuai Tgl Jual yang dipilih?';
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    icon: 'warning',
