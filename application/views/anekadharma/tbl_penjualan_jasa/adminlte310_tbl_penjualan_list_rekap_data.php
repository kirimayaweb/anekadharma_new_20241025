<div class="content-wrapper">
    ...
    <section class="content">
        ...
        $action_cari_rekap = site_url('tbl_penjualan_jasa/RekapData/' . $field_rekap);
                        ...
                        <form id="form-cari-rekap-penjualan" class="rekap-toolbar-satu-baris" action="<?php echo $action_cari_rekap; ?>" method="get">
                            ...
                            <div class="rekap-toolbar-inner">
                                ...
                                <span class="rekap-btn-filter-wrap">
                                    <a href="#" class="btn btn-warning btn-sm btn-rekap-jenis" data-field="nama_barang">Rekap Jasa</a>
                                    <?php if ($is_rekap_barang) { ?>
                                    <select id="rekap-filter-barang" class="form-control form-control-sm rekap-filter-select" title="Filter NAMA JASA">
                                        <option value="">â€” Semua Barang â€”</option>
                                ...
                                <span class="rekap-btn-filter-wrap">
                                    ...
                                    <select id="rekap-filter-konsumen" class="form-control form-control-sm rekap-filter-select" title="Filter konsumen">
                                        <option value="">â€” Semua Konsumen â€”</option>
                        ...
                        <table id="tglSPOPFreeze" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <!-- Baris ke 2 untuk DATA PENJUALAN JASA dari group / kelompok pertama -->
                                        <tr>
                                            <td><?php echo ++$start; ?></td>
                                            <td></td>
                                            <td>
                                        ...
                                        //     c. 1 baris data NAMA JASA baru dari $field_rekap baru
                                        ...
                                        ?>
                                            ...
                                            <!-- Baris GROUP SAMA -> LIST NAMA JASA -->
                                            <tr>
                                                <td><?php echo ++$start; ?></td>
                                                <td></td>
                                                <td>
...
function cetakExcelRekapData() {
    ...
    form.method = 'POST';
    form.action = <?php echo json_encode(site_url('tbl_penjualan_jasa/excel_rekap_data')); ?>;
