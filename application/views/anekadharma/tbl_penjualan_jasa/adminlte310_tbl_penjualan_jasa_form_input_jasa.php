            ...
            <div class="col-md-12">
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo $action_ubah_detail_nomor_kirim; ?>" id="form_update_nmrkirim" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-muted d-block mt-1" id="info-bulan-persediaan-penjualan">
                                    Daftar jasa (persediaan) bulan: <strong><?php echo htmlspecialchars($filter_bulan_penjualan['bulan_label'], ENT_QUOTES, 'UTF-8'); ?></strong>
                        ...
                        <form id="form-reload-penjualan-inisiasi" method="post" action="<?php echo site_url('tbl_penjualan_jasa/create_action_inisiasi/new'); ?>" class="d-none" aria-hidden="true">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-12" text-align="center"> <strong>Detail Jasa</strong> <button type="button" class="btn btn-warning btn-lg" id="btn-input-detail-barang-penjualan">
                                            Input Detail Jasa
                                        </button></div>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                        echo anchor(site_url('tbl_penjualan_jasa/delete/' . $list_data->id . '/' . $list_data->uuid_penjualan), 'Hapus DATA', 'onclick="javascript: return confirm(\'Anda Yakin akan Menghapus Penjualan Barang ini ?\')"');

                                                        // echo anchor(site_url('tbl_penjualan_jasa/delete/' . $list_data->id . '/' . $list_data->uuid_penjualan), 'onclick="javascript: return confirm(\'Anda Yakin akan Menghapus Penjualan Barang ini ?\')"', '<i class="btn btn-outline-info btn-block btn-flat" aria-hidden="true">Hapus</i>', 'class="btn btn-block btn-flat"  ');
                        ...
                        <!-- <button type="submit" class="btn btn-primary"><?php //echo $button 
                                                                            ?></button> -->
                        <button type="button" class="btn btn-default" id="btn-kembali-halaman-penjualan">Kembali ke Halaman DATA PENJUALAN JASA</button>
                        <?php
                        if (isset($uuid_penjualan)) {
                        ?>

                            <a href="<?php echo site_url('tbl_penjualan_jasa/cetak_penjualan_per_uuid_penjualan/' . $uuid_penjualan) ?>" class="btn btn-primary" target="_blank">Cetak Penjualan</a>

                        <?php
                        }
                        ?>

                        <!-- <a href="<?php //echo site_url('tbl_penjualan_jasa') 
...
<div class="modal fade modal-pilih-jasa-penjualan" id="modal-xl" tabindex="-1">
    <div class="modal-dialog modal-pilih-jasa-wide">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="modal-pilih-jasa-loading" class="text-center text-muted py-3 d-none">Memuat data persediaan...</div>
                <div class="modal-pilih-jasa-table-wrap card-body p-0">

                    <table id="table-pilih-jasa-penjualan" class="display nowrap table table-bordered table-sm" style="width:100%">
                ...
                <div id="container-modal-pilih-jasa-nested"><?php echo $render_modal_pilih_barang['modals']; ?></div>
