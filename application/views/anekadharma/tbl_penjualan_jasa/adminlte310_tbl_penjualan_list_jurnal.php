                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="row">
                                    ...
                                    <div class="col-2" text-align="center"> 
                                        <strong>
                                        <?php 
                                        // echo anchor(site_url('tbl_penjualan_jasa/create'), 'Input Penjualan Jasa Baru', 'class="btn btn-danger"'); 
                                        ?>
                                    </strong>
                                </div>
                            ...
                            <div class="col-2">
                            <?php //echo anchor(site_url('tbl_penjualan_jasa/RekapPenjualanPerBarang'), 'Rekap Penjualan', 'class="btn btn-success"'); ?>
                            </div>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                //     echo "<br/>";
                                                //     echo anchor(site_url('tbl_penjualan_jasa/ubah_kode_akun/' . $list_data->nmrkirim), '<i class="fa fa-pencil-square-o" aria-hidden="true">UBAH KODE AKUN</i>', 'class="btn btn-warning btn-xs"');
                                                // }else{
                                                //     echo anchor(site_url('tbl_penjualan_jasa/input_kode_akun/' . $list_data->nmrkirim), '<i class="fa fa-pencil-square-o" aria-hidden="true">INPUT KODE AKUN</i>', 'class="btn btn-danger btn-xs"');
                                                // }
                                                ?>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($list_data->kode_akun) {
                                                    ...
                                                    echo anchor(site_url('tbl_penjualan_jasa/ubah_kode_akun/' . $list_data->nmrkirim . '/' . $Get_date ), '<i class="fa fa-pencil-square-o" aria-hidden="true">UBAH KODE AKUN</i>', 'class="btn btn-warning btn-xs"');
                                                }else{
                                                    echo anchor(site_url('tbl_penjualan_jasa/input_kode_akun/' . $list_data->nmrkirim . '/' . $Get_date), '<i class="fa fa-pencil-square-o" aria-hidden="true">INPUT KODE AKUN</i>', 'class="btn btn-danger btn-xs"');
                                                }
                                            ...
                                            <td>
                                                ...
                                                echo anchor(site_url('tbl_penjualan_jasa/cetak_penjualan_per_uuid_penjualan/' . $list_data->uuid_penjualan . '/' . $date_tgl_jual . '/' . $list_data->nmrkirim), '<i class="fa fa-pencil-square-o" aria-hidden="true">Cetak </i>', 'class="btn btn-success btn-xs"  target="_blank"');

                                                // echo anchor(site_url('tbl_penjualan_jasa/kasir_penjualan/' . $list_data->uuid_penjualan . '/' . $date_tgl_jual . '/' . $list_data->nmrkirim), '<i class="fa fa-pencil-square-o" aria-hidden="true">Tambah </i>', 'class="btn btn-danger btn-xs"  target="_blank"');
                                                
                                                echo anchor(site_url('tbl_penjualan_jasa/kasir_penjualan/' . $list_data->uuid_penjualan), '<i class="fa fa-pencil-square-o" aria-hidden="true">Ubah Data</i>', 'class="btn btn-warning btn-xs"  ');
                                            ...
                                            <td align="left">
                                                ...
                                                // echo anchor(site_url('tbl_penjualan_jasa/update_penjualan/' . $list_data->uuid_penjualan_proses), '<i class="fa fa-pencil-square-o" aria-hidden="true">Ubah</i>', 'class="btn btn-warning btn-xs"  ');
                                                // echo "";
                                                // HAPUS
                                                // echo anchor(site_url('tbl_penjualan_jasa/delete/' . $list_data->id), 'Hapus', 'onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus DATA PENJUALAN JASA ini ?\')" ');
                                                ?>
                                            </td>
