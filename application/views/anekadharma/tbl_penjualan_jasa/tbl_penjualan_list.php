...
<html>
    ...
    <body>
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('tbl_penjualan_jasa/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('tbl_penjualan_jasa/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('tbl_penjualan_jasa'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('tbl_penjualan_jasa/read/'.$tbl_penjualan->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('tbl_penjualan_jasa/update/'.$tbl_penjualan->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('tbl_penjualan_jasa/delete/'.$tbl_penjualan->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('tbl_penjualan_jasa/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
