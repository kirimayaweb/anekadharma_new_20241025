                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="row">
                                    <div class="col-12" text-align="center"> <strong>Ubah DATA PENJUALAN JASA</strong></div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        Untuk proses perubahan NAMA JASA penjualan dan yang lain , caranya:
                        <br />
                        1. Silahkan Ubah NAMA JASA penjualan terlebih dahulu, jika akan ada perubahan NAMA JASA penjualan.
                        <br />
                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <label for="nama_barang">NAMA JASA <?php echo form_error('nama_barang') ?></label>
                                        ...
                                        <input type="text" class="form-control" rows="3" name="nama_barang" id="nama_barang" placeholder="NAMA JASA" value="<?php echo $nama_barang; ?>" required>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left">
                                                                    <?php
                                                                    echo anchor(site_url('tbl_penjualan_jasa/update_action_pilih_barang/' . $uuid_penjualan_proses . "/Update_barang/" . $list_data->id_persediaan_barang), '<i class="fa fa-pencil-square-o" aria-hidden="true">PILIH JASA</i>', 'class="btn btn-warning btn-xs"  ');
                            ...
                            <a href="<?php echo site_url('tbl_penjualan_jasa') ?>" class="btn btn-default">Cancel</a>
                        </form>
                    </div>
                    <!-- /.card-body -->
                </div>
