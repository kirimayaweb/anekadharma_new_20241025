                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="row">
                                    ...
                                    <div class="col-7" text-align="center"> <strong><?php echo anchor(site_url('tbl_penjualan_jasa/create'), 'Input Penjualan Jasa Baru', 'class="btn btn-danger"'); ?></strong></div>
                        ...
                        <table id="tglSPOPFreeze" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                foreach ($Tbl_penjualan_data as $list_data) {
                                    ...
                                    if (($start >= 1) and ($compare_nmr_kirim == $list_data->nmrkirim)  and ($compare_tgl_jual == $list_data->tgl_jual)) {
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            ...
                                            <td align="left">
                                                ...
                                                echo "";
                                                // echo anchor(site_url('tbl_penjualan_jasa/delete/' . $list_data->uuid_penjualan_proses), '<i class="fa fa-pencil-square-o" aria-hidden="true">Hapus</i>', 'class="btn btn-danger btn-xs"  ');
                                        ...
                                        ?>
                                            ...
                                            <td align="left">
                                                ...
                                                echo $list_data->nmrpesan;
                                                echo "<br/>";
                                                // echo anchor(site_url('tbl_penjualan_jasa/cetak_penjualan_per_uuid_penjualan/' . $list_data->uuid_penjualan), '<i class="fa fa-pencil-square-o" aria-hidden="true">Cetak Penjualan</i>', 'class="btn btn-success btn-xs"  target="_blank"');
                                                // echo "";
                                                echo anchor(site_url('tbl_penjualan_jasa/update_penjualan/' . $list_data->uuid_penjualan_proses), '<i class="fa fa-pencil-square-o" aria-hidden="true">Ubah</i>', 'class="btn btn-warning btn-xs"  ');
                                                echo "";
                                                // echo anchor(site_url('tbl_penjualan_jasa/delete/' . $list_data->id), '<i class="fa fa-pencil-square-o" aria-hidden="true">Hapus</i>', 'class="btn btn-danger btn-xs"  target="_blank"');
