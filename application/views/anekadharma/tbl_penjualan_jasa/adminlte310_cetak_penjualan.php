<head>
	<style>
		...
		/* Grid faktur: semua sel Courier New 0.9em (header, data, terbilang, total) â€” dot matrix */
...
<body>
	...
	<table id="customers">
		...
		<tr>
			...
			<!-- <th style="font-size: 0.75em;text-align:left; width: 375px;border: 1px solid black;  border-right:none;  border-collapse: collapse;" colspan="375"><strong>NAMA JASA</strong></th> -->
		...
		<tr class="cetak-barang cetak-barang-header">
			...
			<th style="width: 280px; border: 1px solid black; border-right: none; border-collapse: collapse;" colspan="280">NAMA JASA</th>
		...
		<!-- TANDA TANGAN â€” jarak vertikal rapat antara baris total dan blok Penerima -->
		<tr>
