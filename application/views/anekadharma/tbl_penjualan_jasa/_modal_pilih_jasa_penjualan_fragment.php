				...
				<div class="modal-dialog modal-lg modal-isi-jumlah-barang">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Isi Jumlah Jasa</h4>
							...
							<div class="row">
								...
								<div class="col-md-7 col-12">
									<div class="form-group mb-0">
										...
										<input type="number" class="form-control" id="jumlah_barang_<?php echo (int) $list_data->id; ?>" name="jumlah" min="1" max="<?php echo (int) $sisa_stock_data; ?>" placeholder="Isi jumlah jasa" required>
									</div>
								</div>
							</div>
						</div>
...
if ($fragment_part === 'tbody' && !$ada_baris) {
	echo '<tr><td colspan="10" class="text-center text-muted">Tidak ada jasa persediaan pada bulan ini (sesuai Tgl Jual).</td></tr>';
}
