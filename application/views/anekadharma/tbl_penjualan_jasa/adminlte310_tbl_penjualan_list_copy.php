                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="row">
                                    <div class="col-12" text-align="center"> <strong>DATA PENJUALAN JASA</strong></div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <?php echo anchor(site_url('tbl_penjualan_jasa/create'), 'Input Penjualan Jasa', 'class="btn btn-danger"'); ?>
                            </div>
                            <div class="col-4">
