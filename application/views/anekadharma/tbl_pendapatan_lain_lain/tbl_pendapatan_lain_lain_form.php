...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tbl_pendapatan_lain_lain <?php echo $button ?></h2>
        <form action="<?php echo $action; ?>" method="post">
	    <div class="form-group">
            <label for="varchar">Uuid Pendapatan Lain Lain <?php echo form_error('uuid_pendapatan_lain_lain') ?></label>
            <input type="text" class="form-control" name="uuid_pendapatan_lain_lain" id="uuid_pendapatan_lain_lain" placeholder="Uuid Pendapatan Lain Lain" value="<?php echo $uuid_pendapatan_lain_lain; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('tbl_pendapatan_lain_lain') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>