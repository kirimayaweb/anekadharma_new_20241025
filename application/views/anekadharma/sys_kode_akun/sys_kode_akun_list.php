...
<body>
    <h2 style="margin-top:0px">Sys_kode_akun List</h2>
    <div class="row" style="margin-bottom: 10px">
        <div class="col-md-4">
            <?php echo anchor(site_url('sys_kode_akun/create'), 'Create', 'class="btn btn-primary"'); ?>
        </div>
        ...
        <div class="col-md-3 text-right">
            <form action="<?php echo site_url('sys_kode_akun/index'); ?>" class="form-inline" method="get">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        ...
                        if ($q <> '') {
                        ?>
                            <a href="<?php echo site_url('sys_kode_akun'); ?>" class="btn btn-default">Reset</a>
                        <?php
                        }
                        ?>
    ...
    <table class="table table-bordered" style="margin-bottom: 10px">
        <tr>
            ...
            <tr>
                ...
                <td><?php echo $sys_kode_akun->uuid_kode_akun ?></td>
