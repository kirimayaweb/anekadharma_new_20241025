	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title">INPUT DATA TBL_PRODUK</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">

				<table class='table table-bordered>' <tr>
					<!-- <td width='200'>Uuid Produk <?php //echo form_error('uuid_produk') 
														?></td>
					<td>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="kode_produk" id="$kode_produk" placeholder="Tingkat" value="<?php echo $kode_produk; ?>" />
							<?php echo form_error('$kode_produk') ?></td>
					</tr>
					<tr>
						<td width='200'>Tingkat <?php echo form_error('tingkat') ?></td>
						<td><input type="text" class="form-control" name="tingkat" id="tingkat" placeholder="Tingkat" value="<?php echo $tingkat; ?>" /></td>
					</tr>
					<tr>
					...
					<!-- <tr>
						<td width='200'>Tahun <?php //echo form_error('tahun') 
												?></td>
