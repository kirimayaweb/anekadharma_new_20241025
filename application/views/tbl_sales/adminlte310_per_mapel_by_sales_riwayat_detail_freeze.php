            ...
            <div class="col-md-12">
                <div class="card card-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 card-title">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3" align="left">RIWAYAT TRANSAKSI :</div>
                                
                                    <div class="col-sm-6"  align="left">
                                        <?php
                                        $action_kode_sales = site_url('tbl_sales/riwayat_per_sales/'); 
                                                    ?>
                                                            ...
                                                            <!-- <div class="row"> -->
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="uuid_sales" id="uuid_sales" class="form-control select2" style="width: 100%; height: 40px;">
                                                                        ...
                                                                        <option value="<?php echo $uuid_sales_selected ?>"><?php if ($uuid_sales_selected) {
                                                                                                                                                                                        echo $nama_sales_selected;
                                                                                                                                                                                    } else {
                                                                                                                                                                                        echo "Pilih Sales / Customer";
                                                                                                                                                                                    } ?></option>
                                                                        <?php
                                                                        $sql = "select * from tbl_sales order by  nama_sales ";
                                                                    ...
                                                                    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo "CARI DATA SALES" ?></button>
                                                                </div>
                                                                <!-- <div class="col-sm-4">
                                                                    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo "CARI DATA SALES" ?></button>
                                                                </div> -->
                            ...
                            <div class="col-2 card-title">
                                <form action="<?php echo $action_kirim; ?>" method="post">
                            ...
                            <div class="col-2  card-title">
                                <form action="<?php echo $action_jenis; ?>" method="post">
                                    <select name="jenis_data" id="jenis_data" class="form-control select2" style="width: 200px; height: 10px;">
                                        <?php
                                        if (!empty($_SESSION['jenis_data_selected'])) {
                                        ?>
                    ...
                    <div class="card-body">
                        ...
                        <table id="example99" class="stripe row-border order-column" cellspacing="0" width="100%">
                            <thead>
                                    ...
                                    if (!empty($RIWAYAT_RETUR)) {
                                        foreach ($RIWAYAT_RETUR as $RIWAYAT_RETUR_list) {
                                            ...
                                            if($jenis_data_selected_X == "BARU" AND $get_sys_cover['keterangan'] <> "buku_lama" )
                                            {
                                                ...
                                                echo "<th style='text-align:right;font-size:0.7vw'> RETUR: ". $get_sys_cover['nama_cover'] ."<br/>" . $DATE_DATA  . "<br/>" . anchor(site_url('trans_retur/update_retur/' . $uuid_sales_selected . "/" . $RIWAYAT_RETUR_list->uuid_trans_retur . "/" . $RIWAYAT_RETUR_list->date_input), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Ubah Data Retur', 'class="btn btn-primary btn-sm"') . "</th>";
