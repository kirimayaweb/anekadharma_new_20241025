                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            echo anchor(site_url('tbl_sales/riwayat_per_sales3view/' . $tbl_sales->uuid_sales), '<i class="fa fa-eye" aria-hidden="true">RIWAYAT</i>', 'class="btn btn-success btn-sm" target="_blank"');
                                            echo "<br/>";
