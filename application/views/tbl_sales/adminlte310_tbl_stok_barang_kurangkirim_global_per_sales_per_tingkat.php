                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="font-size:0.7vw" align="right"><?php
                                                                                    echo anchor(site_url('Tbl_sales/detail_kurang_kirim_by_sales_by_tingkat/' . $uuid_sales_selected . '/' . $tbl_stok_barang_detail->tingkat .'/' . $tbl_stok_barang_detail->status_data), '<i class="fa fa-pencil-square-o" aria-hidden="true">DETAIL</i>', 'class="btn btn-primary btn-sm" target="_blank"');
                                                                                    ?></td>
