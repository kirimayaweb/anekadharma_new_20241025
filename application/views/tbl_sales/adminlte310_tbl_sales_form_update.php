			...
			<div class="col-md-12">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">UBAH DATA SALES : </h3>
					</div>
					<div class="card-body">
									...
									<td>
										...
										<div class="col-sm-5 card-title">
											<select name="uuid_sales_rekomendasi" id="uuid_sales_rekomendasi" class="form-control select2" style="width: 100%; height: 40px;">
												...
												<?php
													if($uuid_sales_rekomendasi){
														$this->db->where('uuid_sales', $uuid_sales_rekomendasi);
														$get_data_sales = $this->db->get('tbl_sales');
														$data_sales = $get_data_sales->row_array();
												?>
														<option value='<?php echo $uuid_sales_rekomendas; ?>'> <?php  echo $data_sales['nama_sales']; ?> </option>
												<?php
													}
												?>
