                                ...
                                ?>
                                    <tr>
                                        ...
                                        foreach ($tbl_stok_barang_detail_cover as $tbl_stok_barang_detail_cover_list) {
                                            ...
                                            $X_COVER = $tbl_stok_barang_detail_cover_list->nama_cover . "_PEMESANAN_BARU_" . $tbl_stok_barang_detail->tingkat;
                                            echo "<td style='text-align:right;font-size:0.7vw'>" . nominal($tbl_stok_barang_detail->$X_COVER) . "</td>";
                                            $total_mapel = $total_mapel + $tbl_stok_barang_detail->$X_COVER;
                                        }
                                        ?>
                                        <td style="font-size:0.7vw" align="right"><?php echo nominal($total_mapel); ?></td>
                                        <td style="font-size:0.7vw" align="right"><?php
                                                                                    echo anchor(site_url('Tbl_sales/detail_pemesanan_by_sales_by_tingkat/' . $uuid_sales_selected . '/' . $tbl_stok_barang_detail->tingkat), '<i class="fa fa-pencil-square-o" aria-hidden="true">DETAIL</i>', 'class="btn btn-success btn-sm"');
                                                                                    ?></td>
                                        <td style="font-size:0.7vw" align="right"><?php
                                        ...
                                        <td style="font-size:0.7vw" align="right"><?php
                                                                                    ...
                                                                                    ?></td>
                                        <td style="font-size:0.7vw" align="right"><?php
                                                                                    echo anchor(site_url('Tbl_sales/detail_kurang_kirim_by_sales_by_tingkat/' . $uuid_sales_selected . '/' . $tbl_stok_barang_detail->tingkat), '<i class="fa fa-pencil-square-o" aria-hidden="true">DETAIL</i>', 'class="btn btn-primary btn-sm"');
                                                                                    ?></td>
