                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            $X_PEMESANAN = "PEMESANAN_" . $tbl_stok_barang_detail->status_data . "_" . $tbl_stok_barang_detail->tingkat;
                                            // echo "<td style='text-align:right;font-size:0.7vw'>" . nominal($tbl_stok_barang_detail->$X_PEMESANAN) . "</td>";
                                            // $total_PEMESANAN_PER_TINGKAT = $total_PEMESANAN_PER_TINGKAT + $tbl_stok_barang_detail->$X_PEMESANAN;
                                        ?>
                                        <td style="font-size:0.7vw" align="right"><?php echo nominal($tbl_stok_barang_detail->$X_PEMESANAN); ?></td>
                                        ...
                                        <?php
                                            ...
                                            $X_PENJUALAN = "PENJUALAN_" . $tbl_stok_barang_detail->status_data . "_" . $tbl_stok_barang_detail->tingkat;
                                            // echo "<td style='text-align:right;font-size:0.7vw'>" . nominal($tbl_stok_barang_detail->$X_PENJUALAN) . "</td>";
                                            // $total_PEMESANAN_PER_TINGKAT = $total_PEMESANAN_PER_TINGKAT + $tbl_stok_barang_detail->$X_PENJUALAN;
                                        ?>
                                        <td style="font-size:0.7vw" align="right"><?php echo nominal($tbl_stok_barang_detail->$X_PENJUALAN); ?></td>
                                        ...
                                        <td style="font-size:0.7vw" align="right">
                                            <?php 
                                                if($tbl_stok_barang_detail->$X_PEMESANAN>0){
                                                    echo nominal($tbl_stok_barang_detail->$X_PEMESANAN - $tbl_stok_barang_detail->$X_PENJUALAN);
                                                }else{
                                                    echo "0";
                                                } 
                                            ?>
                                        ...
                                        <td style="font-size:0.7vw" align="right"><?php
                                                                                    if($uuid_sales_selected){
                                                                                        echo anchor(site_url('Tbl_sales/detail_kurang_kirim_ALL_by_tingkat/' . $uuid_sales_selected . '/' . $tbl_stok_barang_detail->tingkat .'/' . $tbl_stok_barang_detail->status_data), '<i class="fa fa-pencil-square-o" aria-hidden="true">DETAIL</i>', 'class="btn btn-primary btn-sm" target="_blank"');
                                                                                    }else{
                                                                                        echo anchor(site_url('Tbl_sales/detail_kurang_kirim_ALL_by_tingkat/'  . $tbl_stok_barang_detail->tingkat .'/' . $tbl_stok_barang_detail->status_data), '<i class="fa fa-pencil-square-o" aria-hidden="true">DETAIL</i>', 'class="btn btn-primary btn-sm" target="_blank"');
                                                                                    }
                                                                                    ?></td>
