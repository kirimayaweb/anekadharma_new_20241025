<div class="content-wrapper">
    <section class="content">
        <?php echo alert('alert-info', 'PROSES PEMESANAN', 'Data Berhasil Diperbaharui')?>
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr><td>User / Pemesan</td><td><?php echo cmb_dinamis('test', 'tbl_user', 'full_name', 'id_users') ?></td></tr>
                        </table>
