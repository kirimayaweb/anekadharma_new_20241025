    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">TAMBAH ACCOUNT / USER</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <table class='table table-bordered>' <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo form_dropdown('id_user_level', array('2' => 'MANAGER', '3' => 'GUDANG', '4' => 'USER', '5' => 'SALES', '6' => 'CUSTOMER'), $id_user_level, array('class' => 'form-control')); ?>
                    ...
                    <!-- <tr><td width='200'>Foto Profile <?php //echo form_error('images') 
                                                            ?></td><td> <input type="file" name="images"></td></tr> -->
