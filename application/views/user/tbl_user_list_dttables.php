<div class="content-wrapper">
    <div class="row" padding-left="100px">
        <section class='content padding-left="10px"'>
            <div class='row'>
                <div class='col-xs-12'>
                    <div class='box'>
                        <div class='box-header bg-yellow' align="center">
                            <h3 class='box-title'> <strong> LIST DATA USER </strong> </h3>
                        </div>

                        <div class="box">
                            <?php echo anchor('#', 'Daftar USER Baru', array('class' => 'btn btn-danger btn-sm')); ?>
                            <?php //echo anchor(site_url('tbl_penyewa/excel'), ' <i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-primary btn-sm"'); 
                            ?>
                            <?php //echo anchor(site_url('tbl_penyewa/word'), '<i class="fa fa-file-word-o"></i> Word', 'class="btn btn-primary btn-sm"'); 
                            ?>
                            <?php //echo anchor(site_url('tbl_penyewa/pdf'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-primary btn-sm"'); 
                            ?>
                        </div><!-- /.box-header -->
                        <div class='box-body'>
