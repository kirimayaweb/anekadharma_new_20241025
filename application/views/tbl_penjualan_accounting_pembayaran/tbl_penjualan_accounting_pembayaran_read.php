...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tbl_penjualan_accounting_pembayaran Read</h2>
        <table class="table">
	    <tr><td>Uuid Pembayaran</td><td><?php echo $uuid_pembayaran; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('tbl_penjualan_accounting_pembayaran') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>