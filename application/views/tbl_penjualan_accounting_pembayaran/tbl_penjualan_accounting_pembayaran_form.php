...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tbl_penjualan_accounting_pembayaran <?php echo $button ?></h2>
        <form action="<?php echo $action; ?>" method="post">
	    <div class="form-group">
            <label for="varchar">Uuid Pembayaran <?php echo form_error('uuid_pembayaran') ?></label>
            <input type="text" class="form-control" name="uuid_pembayaran" id="uuid_pembayaran" placeholder="Uuid Pembayaran" value="<?php echo $uuid_pembayaran; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('tbl_penjualan_accounting_pembayaran') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>