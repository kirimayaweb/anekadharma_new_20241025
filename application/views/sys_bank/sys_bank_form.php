...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            <label for="varchar">Uuid Bank <?php echo form_error('uuid_bank') ?></label>
            <input type="text" class="form-control" name="uuid_bank" id="uuid_bank" placeholder="Uuid Bank" value="<?php echo $uuid_bank; ?>" />
        </div>
	    <div class="form-group">
