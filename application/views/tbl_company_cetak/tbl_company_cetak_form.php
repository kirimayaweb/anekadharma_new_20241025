    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA TBL_COMPANY_CETAK</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">

                <table class='table table-bordered>' <tr>
                    <!-- <td width='200'>Uuid Company Cetak <?php //echo form_error('uuid_company_cetak') 
                                                            ?></td>
                    <td><input type="text" class="form-control" name="uuid_company_cetak" id="uuid_company_cetak" placeholder="Uuid Company Cetak" value="<?php //echo $uuid_company_cetak; 
                                                                                                                                                            ?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="id" value="<?php echo $id; ?>" />
                            ...
                            <a href="<?php echo site_url('tbl_company_cetak') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
                        </td>
                    </tr>
                </table>
            </form>
