...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tbl_company_cetak Read</h2>
        <table class="table">
	    <tr><td>Uuid Company Cetak</td><td><?php echo $uuid_company_cetak; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('tbl_company_cetak') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>