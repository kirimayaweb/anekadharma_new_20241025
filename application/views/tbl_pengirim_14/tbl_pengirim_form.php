...
<table class='table table-bordered>'        
        ...
        <tr><td width='200'>Kode Pengirim <?php echo form_error('kode_pengirim') ?></td><td> <textarea class="form-control" rows="3" name="kode_pengirim" id="kode_pengirim" placeholder="Kode Pengirim"><?php echo $kode_pengirim; ?></textarea></td></tr>
	    ...
	    <a href="<?php echo site_url('tbl_pengirim_14') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>