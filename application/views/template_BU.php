...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/adminlte/bower_components/font-awesome/css/font-awesome.css">
    <!-- Ionicons -->
    ...
    <!-- <link rel="stylesheet" href="<?php //echo base_url() 
                                        ?>assets/AdminLTE310/dist/css/adminlte.min.css"> -->
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <div class="pull-right hidden-xs">
                <!-- <b>Version</b> 2.4.0 -->
                <b>Version</b> 1.0.0 Prototype
            </div>
            <strong>Copyright &copy; 2021 <a href="#">PILAR GROUP</a>.</strong> All rights
            reserved.
        </footer>
