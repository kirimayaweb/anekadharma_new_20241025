...
class Tbl_pembelian_jasa_model extends CI_Model
{

    public $table = 'tbl_pembelian_jasa';
    public $id = 'id';
    ...
    function json()
    {
        ...
        $this->datatables->from('tbl_pembelian_jasa');
        //add this line for join
        //$this->datatables->join('table2', 'tbl_pembelian_jasa.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('tbl_pembelian_jasa/read/$1'), 'Read') . " | " . anchor(site_url('tbl_pembelian_jasa/update/$1'), 'Update') . " | " . anchor(site_url('tbl_pembelian_jasa/delete/$1'), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
    ...
    function stock()
    {
        ...
        $sql = "SELECT 
        tbl_pembelian_jasa_a.id as id_pembelian,
        tbl_pembelian_jasa_a.uuid_pembelian as uuid_pembelian,
        tbl_pembelian_jasa_a.tgl_po as tgl_po,
        tbl_pembelian_jasa_a.kode_barang as kode_barang,
        tbl_pembelian_jasa_a.uraian as nama_barang_beli,
        tbl_pembelian_jasa_a.satuan as satuan,
        tbl_pembelian_jasa_a.jumlah as jumlah_belanja,
        tbl_pembelian_jasa_a.harga_satuan as harga_satuan_beli,
        tbl_pembelian_jasa_a.uuid_gudang as uuid_gudang,
        tbl_pembelian_jasa_a.nama_gudang as nama_gudang,
        ...
        tbl_pembelian_jasa_a.supplier_nama as nama_supplier

        FROM tbl_pembelian_jasa tbl_pembelian_jasa_a 
        -- FROM tbl_penjualan tbl_penjualan_a 

        left join   tbl_penjualan  tbl_penjualan_a ON  tbl_penjualan_a.uuid_barang = tbl_pembelian_jasa_a.uuid_pembelian

        group by tbl_pembelian_jasa_a.kode_barang,tbl_pembelian_jasa_a.tgl_po,tbl_pembelian_jasa_a.uraian,tbl_pembelian_jasa_a.uuid_gudang
        order by tbl_pembelian_jasa_a.uraian,tbl_pembelian_jasa_a.tgl_po ASC
        ";
    ...
    function stock_by_gudang($uuid_gudang)
    {
        ...
        where tbl_pembelian_jasa_a.uuid_gudang='$uuid_gudang'
    ...
    function supplier_tagihan()
    {
        ...
        tbl_pembelian_jasa_a.jumlah as jumlah_belanja,
        tbl_pembelian_jasa_a.harga_satuan as harga_satuan_beli,
        (tbl_pembelian_jasa_a.jumlah*tbl_pembelian_jasa_a.harga_satuan) as total_belanja,
        sys_supplier_a.nama_supplier as nama_supplier_1
       

        FROM tbl_pembelian_jasa tbl_pembelian_jasa_a 

        left join   sys_supplier  sys_supplier_a ON  sys_supplier_a.nama_supplier = tbl_pembelian_jasa_a.supplier_nama
...
/* End of file tbl_pembelian_jasa_model.php */
/* Location: ./application/models/tbl_pembelian_jasa_model.php */
