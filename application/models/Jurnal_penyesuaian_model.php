...
class Jurnal_penyesuaian_model extends CI_Model
{
    ...
    public $table = 'jurnal_penyesuaian';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        $this->db->like('id', $q);
	$this->db->or_like('uuid_jurnal_penyesuaian', $q);
    ...
    function insert($data)
    {
        ...
        $this->db->set('uuid_jurnal_penyesuaian', "replace(uuid(),'-','')", FALSE);
        $this->db->insert($this->table, $data);
...
/* End of file Jurnal_penyesuaian_model.php */
/* Location: ./application/models/Jurnal_penyesuaian_model.php */
