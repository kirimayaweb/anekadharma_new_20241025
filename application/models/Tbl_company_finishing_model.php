...
class Tbl_company_finishing_model extends CI_Model
{
    public $table_report_summary = 'report_summary';
    public $table_report_log = 'report_log';
    public $table = 'tbl_company_finishing';
    public $id = 'id';
    public $order = 'DESC';
    ...
    {
        $this->db->like('id', $q);
        $this->db->or_like('uuid_company_finishing', $q);
        ...
        $this->db->or_like('notelp_perusahaan', $q);
    ...
    {
        $this->db->set('uuid_company_finishing', "replace(uuid(),'-','')", FALSE);
...
/* End of file Tbl_company_finishing_model.php */
/* Location: ./application/models/Tbl_company_finishing_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2021-06-20 11:36:08 */
/* http://harviacode.com */