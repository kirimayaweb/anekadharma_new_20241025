...
class User_level_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('userlevel/akses/$1'),'<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm', 'title' => 'Hak Akses Menu'))." 
            ".anchor(site_url('userlevel/akses_keuangan/$1'),'<i class="fa fa-money" aria-hidden="true"></i>', array('class' => 'btn btn-success btn-sm', 'title' => 'Paket Keuangan'))." 
