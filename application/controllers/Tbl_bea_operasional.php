...
class Tbl_bea_operasional extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model(array('Tbl_bea_operasional_model', 'Sys_unit_model', 'Tbl_pembelian_model', 'Tbl_pembelian_pengajuan_bayar_model'));
    ...
    {
        $this->load->view('Tbl_bea_operasional/Tbl_bea_operasional_list');
    }
    ...
    public function cek_pembelian_kaskecil()
    {
        ...
        foreach ($data_Lunas_kas_pembelian->result() as $list_data) {
            ...
            // SELECT * FROM `Tbl_bea_operasional` WHERE `uuid_spop` LIKE 'a383069bb69c11efaa6a246e9611a63c'
            // $sql = "SELECT * FROM `tbl_pembelian` WHERE `statuslu` LIKE 'L' AND `kas_bank` LIKE 'kas'";
            //         $data_Lunas_kas_pembelian = $this->db->query($sql);

            $this->db->where('uuid_spop', $list_data->uuid_spop);
            $data_kas_kecil = $this->db->get('Tbl_bea_operasional');
            ...
            if ($data_kas_kecil->num_rows() > 0) {
                ...
                if ($data_kas_kecil->row()->kredit <> $list_data->harga_total) {
                    ...
                    $this->Tbl_bea_operasional_model->update($data_kas_kecil->row()->id, $data_update);
    ...
    {
        $Tbl_bea_operasional = $this->Tbl_bea_operasional_model->get_all();
        // $start = 0;
        $data = array(
            'Tbl_bea_operasional_data' => $Tbl_bea_operasional,
            // 'start' => $start,
        );
        $this->template->load('anekadharma/adminlte310_anekadharma_topnav_aside', 'anekadharma/Tbl_bea_operasional/adminlte310_Tbl_bea_operasional_list', $data);
    }

    public function json()
    {
        header('Content-Type: application/json');
        echo $this->Tbl_bea_operasional_model->json();
    }

    public function read($id)
    {
        $row = $this->Tbl_bea_operasional_model->get_by_id($id);
        if ($row) {
            $data = array(
                'id' => $row->id,
            ...
            $this->load->view('Tbl_bea_operasional/Tbl_bea_operasional_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('Tbl_bea_operasional'));
        }
    }
    ...
    public function input_saldo()
    {
        ...
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('Tbl_bea_operasional/input_saldo_action'),
            'id' => set_value('id'),
        ...
        $this->template->load('anekadharma/adminlte310_anekadharma_topnav_aside', 'anekadharma/Tbl_bea_operasional/adminlte310_Tbl_bea_operasional_form_pemasukan', $data);
    }

    public function input_saldo_action()
    {
        $this->_rules();
    ...
    public function pembayaran_update($get_id = null, $get_spop = null)
    {
        ...
        // GET DATA KAS KECIL
        $GET_DATA_KAS_KECIL = $this->Tbl_bea_operasional_model->get_by_id($get_id);
        ...
        if ($GET_DATA_KAS_KECIL->uuid_unit) {
            ...
            if ($GET_DATA_KAS_KECIL->unit) {
                ...
                $sql_update_uuid_unit = "UPDATE `Tbl_bea_operasional` SET `uuid_unit`='$get_uuid_unit' WHERE `id`='$get_id'";
        ...
        if ($GET_DATA_KAS_KECIL) {
            if ($get_spop) {
                ...
                // $this->pembayaran_update($get_id,$get_spop);
                // redirect(site_url('Tbl_bea_operasional/pembayaran_update/' . $get_id .'/'.$get_spop));
                ...
                $data = array(
                    'button' => 'Ubah',
                    'action' => site_url('Tbl_bea_operasional/pembayaran_update_action/' . $get_id . '/' . $get_spop . '/' . $Get_spop_lama),
    ...
    public function pembayaran_update_action($get_id = null, $get_spop = null, $Get_spop_lama = null)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Tbl_bea_operasional_model->update($get_id, $data);
    ...
    public function pembayaran($get_spop = null)
    {
        ...
        if ($get_spop) {
            $data = array(
                'button' => 'Simpan',
                'action' => site_url('Tbl_bea_operasional/pembayaran_action/' . $get_spop),
                'id' => set_value('id'),
                'uuid_kas_kecil' => set_value('uuid_kas_kecil'),
                'tanggal' => set_value('tanggal'),
                'unit' => set_value('unit'),
            ...
            $data = array(
                'button' => 'Simpan',
                'action' => site_url('Tbl_bea_operasional/pembayaran_action'),
                'id' => set_value('id'),
                'uuid_kas_kecil' => set_value('uuid_kas_kecil'),
                'tanggal' => set_value('tanggal'),
                'unit' => set_value('unit'),
        ...
        // $this->load->view('Tbl_bea_operasional/Tbl_bea_operasional_form', $data);
        $this->template->load('anekadharma/adminlte310_anekadharma_topnav_aside', 'anekadharma/Tbl_bea_operasional/adminlte310_Tbl_bea_operasional_form_pengeluaran', $data);
    }
    ...
    public function create()
    {
        ...
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('Tbl_bea_operasional/create_action'),
            'id' => set_value('id'),
            'uuid_kas_kecil' => set_value('uuid_kas_kecil'),
            'tanggal' => set_value('tanggal'),
            'unit' => set_value('unit'),
        ...
        // $this->load->view('Tbl_bea_operasional/Tbl_bea_operasional_form', $data);
        $this->template->load('anekadharma/adminlte310_anekadharma_topnav_aside', 'anekadharma/Tbl_bea_operasional/adminlte310_Tbl_bea_operasional_form', $data);
    }
    ...
    {
        $row = $this->Tbl_bea_operasional_model->get_by_uuid_kas_kecil($uuid_kas_kecil);
        ...
        if ($row) {
            ...
            if ($get_spop_update) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('Tbl_bea_operasional/update_action/' . $uuid_kas_kecil . '/' . $get_spop_update),
                ...
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('Tbl_bea_operasional/update_action/' . $uuid_kas_kecil),
                    'id' => set_value('id', $row->id),
                    'uuid_kas_kecil' => set_value('uuid_kas_kecil', $row->uuid_kas_kecil),
                    'uuid_spop' => set_value('uuid_spop', $row->uuid_spop),
                    'tanggal' => set_value('tanggal', $row->tanggal),
            ...
            $this->template->load('anekadharma/adminlte310_anekadharma_topnav_aside', 'anekadharma/Tbl_bea_operasional/adminlte310_Tbl_bea_operasional_form_update', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('Tbl_bea_operasional'));
        }
    ...
    public function update_action($uuid_kas_kecil = null, $get_spop_update = null)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $get_data_kas_kecil = $this->Tbl_bea_operasional_model->get_by_uuid_kas_kecil($uuid_kas_kecil);
            ...
            $this->Tbl_bea_operasional_model->update($this->input->post('id', TRUE), $data);
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            $this->Tbl_bea_operasional_model->delete($id);
    ...
    public function excel()
    {
        ...
        $get_total_debet = 0;
        $get_total_kredit = 0;
        foreach ($this->Tbl_bea_operasional_model->get_all() as $data) {
            $kolombody = 0;
...
/* End of file Tbl_bea_operasional.php */
/* Location: ./application/controllers/Tbl_bea_operasional.php */
